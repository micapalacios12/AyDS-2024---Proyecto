...
Option.create([
                ...
                { text: 'Permitir el intercambio de oxígeno y dióxido de carbono', correct: true,
...
Option.create([
                ...
                { text: 'Permitir la reproducción y asegurar la continuidad de la especie', correct: true,
...
Option.create([
                ...
                { text: 'Testículos, conductos deferentes, vesículas seminales y pene', correct: false,
...
Option.create([
                { text: 'El proceso por el cual el óvulo es transportado por las trompas de Falopio', correct: false,
                  question_id: question18.id },
                { text: 'El proceso por el cual el óvulo es transportado por el útero', correct: false,
                  question_id: question18.id },
                { text: 'La unión del espermatozoide y el óvulo para formar un cigoto', correct: true,
                  question_id: question18.id },
...
Option.create([
                ...
                { text: 'El proceso mediante el cual el útero expulsa su revestimiento(endometrio)', correct: true,
                  question_id: question19.id },
                { text: 'El proceso de la union de espermatozoide y el ovulo', correct: false,
                  question_id: question19.id }
              ])
...
Option.create([
                { text: 'Lleva los alimentos desde la boca hasta el estómago', correct: true,
...
Option.create([
                ...
                { text: 'Almacena los alimentos hasta que puedan ser digeridos', correct: false,
...
Option.create([
                ...
                { text: 'Digiere y absorbe proteínas, grasas e hidratos de carbono', correct: true,
...
Option.create([
                { text: 'Absorbe la sal y el agua de los alimentos, formando las heces', correct: true,
                ...
                { text: 'Produce jugo gástrico para descomponer los alimentos', correct: false,
                  question_id: question5.id }
              ])
...
Option.create([
                { text: 'Transportar oxígeno a las células y eliminar dióxido de carbono', correct: true,
                  question_id: question1.id },
...
Option.create([
                { text: 'Entra por los bronquios y se mezcla con los glóbulos rojos', correct: false,
                  question_id: question2.id },
                { text: 'Entra por la nariz y la boca, donde se filtra y se calienta', correct: true,
                  question_id: question2.id },
                { text: 'Entra directamente por los pulmones sin ningún tipo de filtración', correct: false,
                  question_id: question2.id },
                { text: 'Entra por la tráquea y luego se almacena en los bronquiolos', correct: false,
                  question_id: question2.id }
              ])
...
Option.create([
                { text: 'Tienen paredes gruesas y están cubiertos de capilares musculosos', correct: false,
                  question_id: question4.id },
                { text: 'Tienen paredes delgadas, están húmedos y tienen una gran superficie lobulada', correct: true,
                  question_id: question4.id },
                { text: 'Son rígidos, lo que les permite almacenar más oxígeno', correct: false,
                  question_id: question4.id },
                { text: 'Son pequeños y están aislados de la sangre para evitar infecciones', correct: false,
                  question_id: question4.id }
              ])
...
Option.create([
                { text: 'La sangre se separa usando una centrífuga, que divide sus componentes para análisis detallado',
...
Option.create([
                ...
                { text: 'Lugar donde se implanta y crece el óvulo fertilizado durante el embarazo', correct: true,
                  question_id: question3.id },
                { text: 'Produce las hormonas responsables del ciclo menstrual', correct: false,
                  question_id: question3.id },
...
Option.create([
                { text: 'Producen espermatozoides, las células reproductivas masculinas', correct: true,
                  question_id: question4.id },
                ...
                { text: 'Producen las hormonas responsables del ciclo menstrual', correct: false,
                  question_id: question4.id }
              ])
...
Option.create([
                { text: 'Lavar diariamente el área genital con agua y jabón suave', correct: true,
                  question_id: question5.id },
...
Option.create([
                { text: 'Descompone la comida en nutrientes que son absorbidos y usados como energía', correct: true,
                  question_id: question1.id },
...
Option.create([
                { text: 'Absorbe nutrientes de los alimentos descompuestos y los transfiere al hígado', correct: true,
                  question_id: question2.id },
                { text: 'Descompone los alimentos usando jugos gástricos', correct: false, question_id: question2.id },
                { text: 'Convierte los alimentos en desechos para ser eliminados', correct: false,
                  question_id: question2.id },
                { text: 'Almacena los nutrientes de los alimentos hasta que el cuerpo los necesite', correct: false,
                  question_id: question2.id }
              ])
...
Option.create([
                ...
                { text: 'El hígado filtra las toxinas antes de que los alimentos lleguen al estómago', correct: false,
                  question_id: question3.id },
                { text: 'El hígado descompone los desechos en el intestino grueso', correct: false,
                  question_id: question3.id }
              ])
...
Option.create([
                { text: 'Descomponen la comida en una papilla que el cuerpo puede utilizar', correct: true,
                  question_id: question5.id },
                { text: 'Absorben nutrientes esenciales directamente en el estómago', correct: false,
                  question_id: question5.id },
                { text: 'Convierte los alimentos en energía directamente', correct: false, question_id: question5.id },
                { text: 'Convierte los desechos en agua antes de enviarlos al intestino', correct: false,
                  question_id: question5.id }
              ])
...
Option.create([
                { text: 'Conducen el aire desde la laringe hasta la tráquea', correct: false,
                  question_id: question2.id },
                { text: 'Distribuyen el aire entre los dos pulmones', correct: true, question_id: question2.id },
                { text: 'Son responsables del intercambio de gases en los pulmones', correct: false,
                  question_id: question2.id },
                { text: 'Filtran el aire antes de que llegue a los pulmones', correct: false,
                  question_id: question2.id }
              ])
...
Option.create([
                { text: 'Conducir el aire desde la faringe hasta los bronquios', correct: true,
                  question_id: question4.id },
...
Option.create([
                { text: 'Se contrae para permitir la entrada de aire a los pulmones', correct: true,
                  question_id: question5.id },
                ...
                { text: 'Almacena el dióxido de carbono antes de la exhalación', correct: false,
                  question_id: question5.id }
              ])
...
Option.create([
                { text: 'Transportar sangre desde el corazón hacia diferentes partes del cuerpo', correct: true,
                  question_id: question2.id },
                { text: 'Transportar sangre desde el cuerpo hacia el corazón', correct: false,
                  question_id: question2.id },
...
Option.create([
                ...
                { text: 'Transportar sangre desde el corazón a los órganos principales', correct: false,
                  question_id: question3.id },
                { text: 'Almacenar sangre oxigenada hasta que sea necesaria', correct: false,
                  question_id: question3.id },
...
Option.create([
                ...
                { text: 'Preparar su revestimiento para nutrir un óvulo fertilizado', correct: true,
                  question_id: question2.id },
...
Option.create([
                { text: 'Transportan el esperma maduro fuera de los testículos', correct: true,
                  question_id: question4.id },
